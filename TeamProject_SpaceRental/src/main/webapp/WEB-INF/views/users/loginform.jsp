...
<body>
									...
									<div class="text-center pt-1 mb-5 pb-1">
										...
										<div>
											<img id="kakaoLoginBtn"
												...
												onClick="javascript:onKakaoLoginBtn()" />
										</div>
	...
	<script>
		...
		const onKakaoLoginBtn = function(){
			...
			location.href = 'https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=2d35e9bcdd28d0e1fb622729f22bab0e&redirect_uri=http://localhost:9000/ubiquitous/users/kakaoLoginCode';
		}
	</script>
	<!-- footer include -->
